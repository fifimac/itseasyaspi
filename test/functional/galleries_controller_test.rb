...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { image: @gallery.image, step: @gallery.step, submitted_by: @gallery.submitted_by, user: @gallery.user }
    end
  ...
  test "should update gallery" do
    put :update, id: @gallery, gallery: { image: @gallery.image, step: @gallery.step, submitted_by: @gallery.submitted_by, user: @gallery.user }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
