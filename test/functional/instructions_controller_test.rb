...
class InstructionsControllerTest < ActionController::TestCase
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post :create, instruction: { content: @instruction.content, images: @instruction.images, step: @instruction.step, title: @instruction.title }
    end
  ...
  test "should update instruction" do
    put :update, id: @instruction, instruction: { content: @instruction.content, images: @instruction.images, step: @instruction.step, title: @instruction.title }
    assert_redirected_to instruction_path(assigns(:instruction))
  end
